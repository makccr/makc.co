...
Here is some miscellaneous text that can be formed into a paragraph.
...
How about some [inline links](https://eel-slap.net)? Or some `inline code`? Also probably need some **bold** and some *italicized* text for my testing purposes. ***Bold and italic?*** ~~Strikethrough~~? 

```css
/* Probably need a proper code block as well, no? */
...
Definitely need to do a little test with a proper table: 

| Things I like | Things I don't like |
| --------------| --------------------| 
| writing CSS   | Everyting else      |

And a larger table that will break on mobile displays: 
...
Oh, this isn't a markdown specific thing, but definitely going to want some buttons to play with: 

<a href='#'> 
    <button>CLICK ME RIGHT NOW!</button> 
</a>

Also need to make sure I have a line break: 

---

## Rounding Things Off

Gonna need some lists: 

* Unordered is my favorite
    * List item 1
        * Nested 1 
            * Nested 2 (A bit extreme tbh)
    * List item 2
        * Nested element like a code block: 
        ```bash
        sudo pacman -Syu
        # Pretty dummb, but I do it alot
        ```
    * List item 3

1. Gotta have some ordered lists as well. 
    1. Numbered nested children. 
2. With numbered children.
    * As well as unordered nested children? 
        * Is saying nested children redundant? 
3. Yes. Yes it is.
...
> "Also a short quote with no source for the hell of it."
<p class="attr">
A person<br>
A book
</p>
